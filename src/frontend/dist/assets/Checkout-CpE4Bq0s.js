import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, f as composeRefs, o, g as useComposedRefs, R as React, h as cn, b as useCart, u as useActor, i as useNavigate, P as PaymentMethod, d as createActor } from "./index-CpuXL1W6.js";
...
function Checkout() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await clearCart();
      ue.success("Order placed successfully! We'll contact you shortly.");
      navigate({ to: "/" });
    } catch {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dark", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground mb-5", children: "Delivery Details" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground mb-5", children: "Payment Method" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          RadioGroup,
          {
            value: paymentMethod,
            ...
            children: paymentOptions.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "label",
              {
                htmlFor: opt.value,
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-sm text-foreground", children: opt.label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: opt.desc })
                  ] })
                ]
              },
              opt.value
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
      cart && cart.items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-sm p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
